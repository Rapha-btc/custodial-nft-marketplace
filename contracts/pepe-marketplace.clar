...
(define-constant ERR-FT-NOT-WHITELISTED (err u205))
(define-constant ERR-TRANSFER-FAILED (err u206))
(define-constant ERR-INVALID-PRICE (err u207))
(define-constant ERR-CANNOT-BUY-OWN (err u208))
(define-constant ERR-PAUSED (err u209))
(define-constant ERR-WRONG-NFT (err u210))
(define-constant ERR-ALREADY-INITIALIZED (err u211))
(define-constant ERR-NOT-INITIALIZED (err u212))
(define-constant ERR-WRONG-FT (err u213))

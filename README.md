...
| `fakfun-market-registry` + `fakfun-auctions-stx` (seller timed auctions, anti-snipe) - pre-deploy source | `auctions-stx-test.js` | 71/71 | https://stxer.xyz/simulations/mainnet/65aeb218a2da1fdc16035e744f791141 |

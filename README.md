...
| `fakfun-market-registry` + `fakfun-auctions-stx` (seller timed auctions, anti-snipe) - pre-deploy source | `auctions-stx-test.js` | 71/71 | https://stxer.xyz/simulations/mainnet/11faaeed818ebb2f20afcf1199970cb9 |
...
of 1..1008 burn blocks, same increment rule, previous top refunded on

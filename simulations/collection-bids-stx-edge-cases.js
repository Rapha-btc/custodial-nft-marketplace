...
// Adversarial / edge harness for fakfun-collection-bids-stx at mainnet tip.
// Default deploys ./contracts source in-sim as fakfun-collection-bids-stx-v1;
// DEPLOYED=1 runs against the live -v1 contract. Fee and royalty changes while bids are open (recipients set
...
//   DEPLOYED=1 node simulations/collection-bids-stx-edge-cases.js
...
call("accept unknown", SELLER, "accept-bid", [uintCV(id(99)), uintCV(1654), cp(BPEPE), uintCV(1)], "(err u306)");
...
call("fill A with #1654", SELLER, "accept-bid", [uintCV(id(1)), uintCV(1654), cp(BPEPE), uintCV(STX(10))], "(ok true)");
...
call("fill B 1/3 with #901", SELLER, "accept-bid", [uintCV(id(2)), uintCV(901), cp(BPEPE), uintCV(STX(4))], "(ok true)");
...
call("fill C with #1654 (bidder now owns it? no - seller sold it)", BIDDER, "accept-bid", [uintCV(id(3)), uintCV(1654), cp(BPEPE), uintCV(STX(1))], "(err u311)");
...
call("fill C with #1445 is Gamma-listed -> NFT refuses", SELLER, "accept-bid", [uintCV(id(3)), uintCV(1445), cp(BPEPE), uintCV(STX(1))], "(err u106)");
...
call("seller fills E with #964 (seller is also both fee recipients)", SELLER, "accept-bid", [uintCV(id(5)), uintCV(964), cp(BPEPE), uintCV(STX(2))], "(ok true)");
...
call("fill F reverts: fee recipient == contract (stx-transfer u2)", SELLER, "accept-bid", [uintCV(id(6)), uintCV(967), cp(BPEPE), uintCV(STX(2))], "(err u2)");
...
call("no fills", SELLER, "accept-bid", [uintCV(id(7)), uintCV(1445), cp(BPEPE), uintCV(STX(1))], "(err u302)");
...
call("liar fill pays although nothing moved", SELLER, "accept-bid", [uintCV(id(8)), uintCV(1), cp([RANDOM, "liar-nft-stx"]), uintCV(STX(1))], "(ok true)");
